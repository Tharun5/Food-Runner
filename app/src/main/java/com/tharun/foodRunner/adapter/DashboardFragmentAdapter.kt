package com.tharun.foodRunner.adapter
...
import com.tharun.foodRunner.R
import com.tharun.foodRunner.activity.RestaurantMenuActivity
import com.tharun.foodRunner.database.RestaurantDatabase
import com.tharun.foodRunner.database.RestaurantEntity
import com.tharun.foodRunner.model.Restaurant
...
class DashboardFragmentAdapter(val context: Context, var itemList: ArrayList<Restaurant>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderDashboard {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.recycler_dashboard_single_view_row, parent, false)
        ...
        holder.txtFavorite.setOnClickListener {
            if (!DBAsyncTask(context, restaurantEntity, 1).execute().get()) {
                ...
                if (result) {
                    ...
                    holder.txtFavorite.background = context.resources.getDrawable(R.drawable.ic_favorite_outline)
